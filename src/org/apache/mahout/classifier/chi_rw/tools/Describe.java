 ...
 */
package org.apache.mahout.classifier.chi_rw.tools;
...
import org.apache.mahout.classifier.chi_rw.data.DescriptorException;
import org.apache.mahout.classifier.chi_rw.data.DescriptorUtils;
...
public final class Describe {
  ...
  private static void runTool(String dataPath, Iterable<String> description, String filePath, boolean regression)
    ...
    Chi_RWUtils.storeWritable(new Configuration(), fPath, dataset);
  }
